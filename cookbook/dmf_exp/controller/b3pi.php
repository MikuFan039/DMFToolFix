...
class b3pi extends K_Controller {
    ...
    public function dad()
	{
        ...
        if (XmlAuth::IsEdit('Bilibili3', $this->Input->Request->id)) {
	...
	public function dad2()
	{
        ...
        $this->DisplayView('bilibili_dad2_xml', $data);
	}
	...
	public function update_comment_time()
	{
        ...
        $dynPool = PoolUtils::GetPool('Bilibili3', $poolId, PoolMode::D);
	...
	public function advanceCommentState()
	{
        die('{"code":0,"message":"0","ttl":1,"data":{"coins":2,"confirm":1,"accept":true,"hasBuy":true}}');
    }
